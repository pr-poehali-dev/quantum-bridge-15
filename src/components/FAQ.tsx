...
const faqs = [
  {
    ...
    answer:
      "Наша студия базируется во Владивостоке, но мы реализуем проекты по всей России. Мы создаем интерьеры, которые откликаются на характер места и потребности каждого клиента.",
  },
  {
    question: "Сколько времени занимает проектирование?",
    answer:
      "Сроки зависят от масштаба и сложности проекта. Типичный жилой объект занимает от 6 до 12 месяцев от первоначальной концепции до финишной отделки. Мы тесно работаем с клиентами, чтобы установить реалистичные сроки для продуманной разработки дизайна.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Мы предоставляем полный спектр услуг по дизайну интерьеров: концепция и стиль, планировочные решения, подбор материалов и мебели, авторский надзор за реализацией. Адаптируем услуги под конкретные потребности вашего проекта.",
  },
  {
