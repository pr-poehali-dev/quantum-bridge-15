...
const faqs = [
  {
    ...
    answer:
      "Наша студия базируется в Москве, но мы реализуем проекты по всей России и в ближнем зарубежье. Мы создаем интерьеры, которые откликаются на характер места и потребности каждого клиента.",
  },
  {
