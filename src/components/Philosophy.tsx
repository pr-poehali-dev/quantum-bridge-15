...
const philosophyItems = [
  ...
  {
    title: "Продуманный подход",
    description:
      "Планировки, вдохновленные ритмом жизни и материальностью. Пространства, которые говорят через пропорции, свет и детали.",
  },
  {
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="space-y-6 lg:pt-48">
            <p className="text-muted-foreground text-lg leading-relaxed max-w-md mb-12">
              Дизайн интерьера — это больше, чем красота. Это то, как мы чувствуем себя дома. Мы создаем пространства, которые питают человеческий дух.
            </p>
